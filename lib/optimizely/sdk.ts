...
export type BlogPostPage = IData &
  _IContent &
  _IPage & {
...
export type BlogSectionExperience = IData &
  _IContent &
  _IExperience &
  _IPage & {
...
export type CarouselBlock = IData &
  _IComponent &
  _IContent & {
...
export type ContentRecsElement = IData &
  _IComponent &
  _IContent & {
...
export type ContinueReadingComponent = IData &
  _IComponent &
  _IContent & {
...
export type LayoutSettingsBlock = IData &
  _IComponent &
  _IContent & {
...
export type Locales = 'ALL' | 'NEUTRAL' | 'en' | 'fr_CA'
...
export type MenuNavigationBlock = IData &
  _IComponent &
  _IContent & {
...
export type OdpEmbedBlock = IData &
  _IComponent &
  _IContent & {
...
export type PartnerTokens = IData &
  _IComponent &
  _IContent & {
...
export type RichTextElement = IData &
  _IComponent &
  _IContent & {
...
export type GetLayoutSettingsQueryVariables = Exact<{
  key: Scalars['String']['input']
}>

export type GetLayoutSettingsQuery = {
  __typename?: 'Query'
  _Content: {
    __typename?: '_ContentOutput'
    items: Array<
      ...
      | {
          ...
          contactInfo: { __typename?: 'RichText'; html: string | null } | null
        }
      | { __typename?: 'MegaMenuGroupBlock' }
      | { __typename?: 'MenuNavigationBlock' }
      | { __typename?: 'OdpEmbedBlock' }
    ...
    items: Array<{
      ...
      TopContentArea: Array<
        ...
        | {
            ...
            HeroImage: {
              __typename?: 'ContentReference'
              url: { __typename?: 'ContentUrl'; base: string | null } | null
            } | null
          }
        | { __typename: 'ImageElement' }
        | { __typename: 'ImageMedia' }
...
export const GetLayoutSettingsDocument = gql`
  query GetLayoutSettings($key: String!) {
...
export function getSdk(
  ...
  return {
    ...
    GetLayoutSettings(
      variables: GetLayoutSettingsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit['signal']
    ): Promise<GetLayoutSettingsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetLayoutSettingsQuery>({
            document: GetLayoutSettingsDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetLandingPageQuery>({
            document: GetLandingPageDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
